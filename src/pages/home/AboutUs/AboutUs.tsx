  ...
  return (
    <VStack w="full" px={5} py={50} spacing={10} id="about-us">
      ...
      >
        ...
        into their wallets by sharing and spreading Cashx Network. CASHX team
        has no control over how much you can earn. All the transactions are
        instant and automatic. Early entry into the system is very important as
        more senior level you reach, higher the upgrade income you receive. Some
        portion of joining fee goes to $CASHX liquidity which increases the
